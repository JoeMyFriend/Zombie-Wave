...
namespace AprendaUnity
{
    ...
    public class fovEditor : Editor
    {
        private void OnSceneGUI()
        {
            ...
            Vector3 viewAngleA = f.DirForAngle(-f.viewAngle / 2);
            Vector3 viewAngleB = f.DirForAngle(f.viewAngle / 2);
            ...
            Vector3 viewAngleAb = f.DirForAngle(-f.viewAngleB / 2);
            Vector3 viewAngleBb = f.DirForAngle(f.viewAngleB / 2);
